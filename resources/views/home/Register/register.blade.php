...
<div class="log_bg">  
  ...
  <div class="regist">
    ...
    <div class="reg_c">
          <form action="/homeregister" id="" method="post">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                ...
                <td>
                <input type="email" value="" name="email" class="l_user" /> 
                </td>
              </tr>
              <tr height="50">
                <td align="right">
                <font color="#ff4e00">*</font>&nbsp;密码 &nbsp;</td>
                <td>
              ...
              <tr height="50">
                <td align="right">
                <font color="#ff4e00">*</font>确认密码 </td>
                <td>
                <input type="password" value="" name="repassword" class="l_pwd" />
                </td>
              </tr>

              <tr height="50">
                <td align="right">
                <font color="#ff4e00">*</font>验证码 </td>
                <td>
              ...
              <tr height="50">
                <td align="right">
                <font color="#ff4e00">*</font>输入验证码 </td>
                <td>
                <input type="text" value="" name="vcode" class="l_pwd" />
                </td>
              </tr>
<!--               <tr height="50">
