...
<meta name="description" content="多快好省" charset="utf-8">
<!-- 引入资源 -->
...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
        	@if(session('id'))
            <span class="fl">你好,<a href="/home/details">{{session('username')}}</a>&nbsp; <a href="/User_logout" style="color:#ff4e00;">注销</a>&nbsp;|&nbsp;<a href="/home/myorder">我的订单</a>&nbsp;|</span>
            @else
            <span class="fl">你好,请<a href="/homelogin">登录</a>&nbsp; <a href="/homeregister/create" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="/home/myorder">我的订单</a>&nbsp;|</span>
            @endif
        	<span class="ss">
            	<div class="ss_list">
                	<a href="/home/collection">收藏夹</a>
                    <div class="ss_list_bg">
                    	<div class="s_city_t"></div>
                        <div class="ss_list_c">
                        	<ul>
                            	<li><a href="/home/collection">我的收藏夹</a></li>
                                <li><a href="/home/collection">我的收藏夹</a></li>
                            </ul>
                        </div>
                    </div>     
...
<div class="top">
    <div class="logo"><a href="/"><img src="/status/home/images/logo.png" /></a></div>
    <div class="search">
    	<form action="/home/query" method="get" class="form-inline">
        <div class="form-group">
            <input type="text" name="query" value="{{old('query')}}" class="form-control" placeholder="请输入你要搜索的商品..." style="width: 430px" />
        </div>
            <input type="submit" value="搜索" class="btn btn-warning" />
            <h4 class="help-block">{{$help or ''}}</h4>
        </form>                      
        <!-- <span class="fl"><a href="#">咖啡</a><a href="#">iphone 6S</a><a href="#">新鲜美食</a><a href="#">蛋糕</a><a href="#">日用品</a><a href="#">连衣裙</a></span> -->
    </div>
    <div class="i_car">
    	<div class="car_t">购物车 [ <span>@if(!empty($cart)) {{count($cart)}} @endif</span> ]</div>
        <div class="car_bg">
        @if(session('id'))
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            ...
            @foreach($cart as $row)
            	<li>
                	<div class="img"><a href="{{url('/home/goods/'.$row->goods_id)}}"><img src="{{url($row->url)}}" width="58" height="58" /></a></div>
                    <div class="name"><a href="{{url('/home/goods/'.$row->goods_id)}}">{{$row->goods_name}}</a></div>
                    <div class="price"><font color="#ff4e00">￥{{$row->price}}</font> X{{$row->num}}</div>
                </li>
                <?php $total += $row->num*$row->price?>
            @endforeach
            @endif
            </ul>
