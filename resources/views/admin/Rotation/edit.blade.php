 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/Rotation/{{$info->id}}" method="post"> 
     <div class="mws-form-inline">  
      <div class="mws-form-row"> 
       <label class="mws-form-label">图片</label> 
       <div class="mws-form-item"> 
      <script id="editor" type="text/plain" name="pic" style="width:800px;height:500px;">{!!$info->pic!!}
        </script>
       </div> 
      </div>
      <div class="mws-form-row"> 
     ...
     <div class="mws-button-row">
      ...
      <input type="reset" value="点击重置" class="btn " /> 
     </div> 
    </form> 
   </div> 
  </div>
