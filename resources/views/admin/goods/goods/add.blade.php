...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="/admin/goods" method="post" role="form" style="max-width: 800px" enctype="multipart/form-data" onsubmit="return validateCommit()">
        <div class="panel-body">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="goods_name" id="goods_name" onblur="validateName()" value="{{old('goods_name')}}">
                             <p class="help-block">
                                请输入您的商品名
                            </p>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="number" class="" name="pricea" id="pricea" style="max-width: 100px"  value="{{old('pricea')}}" onblur='validatePrica()' required> <font style="font-size: 22px"><font color="black">.</font></font> <input type="text" class="" name="priceb" id="priceb" style="max-width: 100px"  value="{{old('priceb')}}" pattern="^[0-9]{2}$"  onblur='validatePriceb()' required> 
                        ...
                        <div class="form-group">
                            ...
                            <select name="cate_id" id="goods_cate">
                                @foreach($cates as $row)
                                    <option value="{{$row->id}}" @if($row->id == old('cate_id')) selected @endif>{{$row->name}}</option>
                                @endforeach
                            </select>
                             <p class="help-block"> 
                                <!-- 请选择一个商品分类 -->
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="number" class="form-control" name="stock" id="stock" onblur="validateName()" value="{{old('stock')}}" required>  <font color="black"> &nbsp;&nbsp;件</font>
                             <p class="help-block">
                                <!-- 请输入您的商品库存 -->
                            </p>
                        </div>
                        <div class="form-group form-inline">
                            ...
                            <input type="number" class="form-control" name="weight" id="weight" onblur="validateName()" value="{{old('weight')}}" required>  <font color="black"> &nbsp;&nbsp;g</font>
                             <p class="help-block">
                                <!-- 请输入您的商品重量 -->
                            </p>
                        </div>
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="text" class="form-control" name="country" id="country" onblur="validateCountry()" value="{{old('country')}}" required>
                             <p class="help-block">
                                请输入您的商品产地/国家
                            </p>
                        </div>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="form-group" style="overflow: auto;max-height: 120px" id="query_brand">
                            ...
                            <label>
                                <input type="radio" name="brand_id" id="brand_id" value="{{$row->brand_id}}" @if($row->brand_id == old('brand_id')) checked @endif>
                ...
                @foreach($specification as $row)
                    ...
                    <label>
                        <input type="checkbox" name="attribute[]" class="form-control" value="{{$v->attr_id}}" @if(!empty(old('attribute'))) @if(in_array($v->attr_id,old('attribute'))) checked @endif @endif>{{$v->attr_name}}
                    </label>
                    @endforeach
                @endforeach
                </div>
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <script id="editor" type="text/plain" name="descr" style="width:700px;height:500px;">{!!old('descr')!!}
                        </script>
                    </div>
                </div>
        </div>
...
@section('js')
<!-- 验证js -->
<script src='/status/admin/js/validate.js'></script>
<!-- UEditor百度编辑器 -->
